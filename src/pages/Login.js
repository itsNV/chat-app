...
const Login = () => {
  ...
  return (
    <div className='flex items-center justify-center w-full h-screen bg-black overflow-hidden relative'>
      ...
      <p className='text-blue-400 absolute top-32 z-10 text-3xl shadow-blue-400 shadow-lg px-6 font-semibold'>Welcome Back !!</p>
          
      <div className='absolute inset-0 w-full h-full overflow-hidden'>
        <video className='absolute min-w-full min-h-full object-cover' autoPlay muted loop >
...
{/*     
      ...
      <form
          ...
          className='border border-white shadow-lg shadow-white h-auto lg:w-[35%] md:w-[40%] md:p-4 sm:w-[50%] sm:p-4 w-[70%] p-4 lg:p-10 flex flex-col gap-10 rounded-lg z-10 relative items-center'>
              ...
              {/* email */}
             <label htmlFor="email" className='flex flex-col gap-3 lg:justify-center '>
